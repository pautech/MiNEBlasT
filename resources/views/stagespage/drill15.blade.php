    ...
    <div class="row">
        <div id="dynamicContent1" class="speech-bubble1"></div>
            <div class="col quiztext" style="position: relative;">
                <h3 style="position: absolute; top: 25%; left: 50%; transform: translate(-50%, -50%); z-index: 1;">It's time for a quiz! Again</h3>
                <p class="fs-5 text-justify ptext text-center" style="position: absolute; top: 53%; left: 50%; width: 70%; transform: translate(-50%, -50%); z-index: 1;">Hello, {{ $userName }}! Engr. Lorry here with a challenge for you. </p>
...
<div class=" mb-3 mt-3 btn d-flex justify-content-end outline-none  border-0">
        ...
        <a class="text-decoration-none text-dark " href="{{ route('drill16') }}"><button type="button" class="rock-btn shadow-lg pl-5 pr-5 ml-3">Next</button> </a>
   ...
   <script>
            document.addEventListener('DOMContentLoaded', function () {
                var jsonData = [
                    ...
                    { "introduction": "This time you are going to Drag and arrange some of the concepts. Please hit that next button to start" },
