...
<a class="text-decoration-none text-dark " href="{{ route('cycleope4') }}"><button type="button" class="rock-btn shadow-lg pl-5 pr-5 ml-3">Back</button></a>
               <a class="text-decoration-none text-dark " href="{{ route('cycleope6') }}"><button type="button" class="rock-btn shadow-lg pl-5 pr-5 ml-3">Next</button></a>
</div>
         <br>
...
document.addEventListener('DOMContentLoaded', function () {
    var jsonData = [
        { "message": "Great! You’ve already learned the common instrument used in surveying. " },
        { "introduction": "Now, let’s learn about the underground mining: Supported and unsupported methods’ rock conditions." },
    ...
    function updateDynamicContent() {
        ...
        message.addEventListener('end', function () {
            ...
            if (currentIndex === jsonData.length - 1) {
                ...
                window.location.href = '{{ route("cycleope6") }}';
                return;
            }
