...
<a class="text-decoration-none text-dark " href="{{ route('cycleope8') }}"><button type="button" class="rock-btn shadow-lg pl-5 pr-5 ml-3">Back</button></a>
 <a class="text-decoration-none text-dark " href="{{ route('cycleope10') }}"><button type="button" class="rock-btn shadow-lg pl-5 pr-5 ml-3">Next</button></a>
</div>
         <br>
...
document.addEventListener('DOMContentLoaded', function () {
    var jsonData = [
        { "message": "Great Job! You’ve passed the first sequence in drilling and blasting cycle. " },
        { "introduction": "Click next to proceed to the next sequence." },
    ...
    function updateDynamicContent() {
        ...
        message.addEventListener('end', function () {
            ...
            if (currentIndex === jsonData.length - 1) {
                ...
                window.location.href = '{{ route("cycleope10") }}';
                return;
            }
