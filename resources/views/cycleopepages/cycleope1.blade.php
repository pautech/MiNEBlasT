...
<a class="text-decoration-none text-dark " href="{{ route('cycleope') }}"><button type="button" class="rock-btn shadow-lg pl-5 pr-5 ml-3">Back</button></a>
<a class="text-decoration-none text-dark " href="{{ route('cycleope2') }}"><button type="button" class="rock-btn shadow-lg pl-5 pr-5 ml-3">Next</button></a>
    ...
    function updateDynamicContent() {
        ...
        message.addEventListener('end', function () {
            ...
            if (currentIndex === jsonData.length - 1) {
                ...
                window.location.href = '{{ route("cycleope2") }}';
                return;
            }
